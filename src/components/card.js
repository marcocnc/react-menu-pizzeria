        ...
        return (
            <div className="col">
                <div className="card" style={{width: '18rem', textAlign: 'center', marginBottom: '2rem'}}>
                    ...
                    {/* Counter div */}
                    <div className="mb-2">
                        <button onClick={()=>this.props.onIncrement(this.props.card)} className="btn btn-success">
                            <i class="fa-solid fa-plus"></i>
                        </button>

                        <span className="badge text-bg-light">( {this.props.card.quantity} )</span>

                        <button onClick={()=>this.props.onDecrement(this.props.card)} className="btn btn-minus btn-danger ">
